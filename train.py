...
parser.add_argument('--list_dir', type=str,
                    default='.deeplearning/sina/MISSFormerV2/lists/lists_Synapse/train.txt', help='list dir')
...
if __name__ == "__main__":
    ...
    dataset_config = {
        'Synapse': {
            ...
            'list_dir': '.deeplearning/sina/MISSFormerV2/lists/lists_Synapse/train.txt',
            'num_classes': 9,
        },
    }
