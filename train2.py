# The baseline of this code has been written by Afshin Bozorgpour #
# The code hasss been modified according to Missformer variants by Sina ghorbani #
...
from networks.MISSFormerV3 import MISSFormer3, MISSFormer4, MISSFormer5, MISSFormer6
...
parser.add_argument('--root_path', type=str,
                    default='/images/PublicDataset/Transunet_synaps/project_TransUNet/data/Synapse/train_npz',
                    help='root dir for data')
parser.add_argument('--test_path', type=str,
                    default='/images/PublicDataset/Transunet_synaps/project_TransUNet/data/Synapse/test_vol_h5',
                    help='root dir for data')
...
parser.add_argument('--dice_loss_weight', type=float,
                    default=0.6,
                    help="You need to determine <x> (default=0.6): => [loss = (1-x)*ce_loss + x*dice_loss]")
...
parser.add_argument('--model_name', type=str,
                    default='missformerv6', help='model_name')
